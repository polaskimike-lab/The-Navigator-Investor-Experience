export function MissionMetric({
  ...
  return (
    <div className={`rounded-3xl border bg-white/[0.045] p-5 backdrop-blur-xl ${toneClass}`}>
      <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-muted">
        {label}
      </p>
      <p className={`mt-3 text-4xl font-semibold tracking-[-0.06em] ${toneClass.split(" ")[0]}`}>
        {value}
      </p>

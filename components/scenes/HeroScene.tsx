  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-5 py-16 text-center">
      ...
      <div className="relative z-10 max-w-7xl">
        <div className="mx-auto mb-8 flex w-fit items-center gap-3 rounded-full border border-blueIntel/30 bg-blueIntel/10 px-5 py-3 backdrop-blur-xl"><span className="h-2 w-2 rounded-full bg-greenSafe shadow-[0_0_18px_rgba(16,185,129,.8)]" /><span className="font-mono text-xs uppercase tracking-[0.26em] text-blueIntel">Mission Briefing Online</span></div>

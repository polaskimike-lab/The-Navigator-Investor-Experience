  ...
  return (
    <div className="relative mx-auto h-[560px] w-full max-w-5xl overflow-hidden rounded-[2rem] border border-line bg-obsidian shadow-glow">
      ...
      <svg className="absolute inset-0 h-full w-full" viewBox="0 0 980 560" aria-hidden="true">
        <defs>
          <radialGradient id="coreGlow"><stop offset="0%" stopColor="#E0F2FE" stopOpacity="1" /><stop offset="35%" stopColor="#38BDF8" stopOpacity=".55" /><stop offset="100%" stopColor="#38BDF8" stopOpacity="0" /></radialGradient>
          <linearGradient id="sphereFlow" x1="0" x2="1"><stop offset="0%" stopColor="#38BDF8" stopOpacity=".2" /><stop offset="50%" stopColor="#38BDF8" stopOpacity=".9" /><stop offset="100%" stopColor="#F59E0B" stopOpacity=".8" /></linearGradient>
        </defs>
